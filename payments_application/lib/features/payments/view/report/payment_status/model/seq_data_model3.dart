class SeqDataModel3 {
  List<SeqData3Response>? response;

  SeqDataModel3({this.response});

  SeqDataModel3.fromJson(Map<String, dynamic> json) {
    if (json['response'] != null) {
      response = <SeqData3Response>[];
      json['response'].forEach((v) {
        response!.add(new SeqData3Response.fromJson(v));
      });
    }
  }
...
class SeqData3Response {
  ...
  SeqData3Response.fromJson(Map<String, dynamic> json) {
