class SeqDataModel5 {
  List<SeqData5Response>? response;

  SeqDataModel5({this.response});

  SeqDataModel5.fromJson(Map<String, dynamic> json) {
    if (json['response'] != null) {
      response = <SeqData5Response>[];
      json['response'].forEach((v) {
        response!.add(new SeqData5Response.fromJson(v));
      });
    }
  }
...
class SeqData5Response {
  ...
  SeqData5Response.fromJson(Map<String, dynamic> json) {
