class CorIDdataModel3 {
  List<CorIdResponse3>? response;

  CorIDdataModel3({this.response});

  CorIDdataModel3.fromJson(Map<String, dynamic> json) {
    if (json['response'] != null) {
      response = <CorIdResponse3>[];
      json['response'].forEach((v) {
        response!.add(new CorIdResponse3.fromJson(v));
      });
    }
  }
