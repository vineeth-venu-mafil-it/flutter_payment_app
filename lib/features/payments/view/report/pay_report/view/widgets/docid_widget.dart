...
class PayDocIdWidget extends StatelessWidget {
  final double? width;
  final double? height;
  final List<PayTransDet>? transDet;
  final List<PayNeftCusDet>? neftCusDet;
  final PayReportController? provider;
  const PayDocIdWidget(
      {super.key,
      this.width,
      this.height,
      this.transDet,
                          ...
                          child: Container(
                            ...
                            child: Theme(
                              ...
                              child: PaginatedDataTable2(
                                ...
                                rowsPerPage: provider!.rowsPerPageTransDet,
                                availableRowsPerPage: const [10, 20, 50],
                                onRowsPerPageChanged: (value) {
                                  provider!
                                      .updateRowsPageTransDet(data: value!);
                                },
                            ...
                            child: Theme(
                              ...
                              child: PaginatedDataTable2(
                                scrollController:
                                    ScrollController(), // Enable scrolling
                                minWidth:
                                    1200, // Adjusted based on column requirements
                                headingRowHeight: 35.0,
                                dataRowHeight: 40.0,
                                horizontalMargin: 16,
                                columnSpacing: 16,
                                ...
                                dividerThickness: 0.5,
                                rowsPerPage: provider!.rowsPerPageNeftCusDet,
                                availableRowsPerPage: const [10, 20, 50],
                                onRowsPerPageChanged: (value) {
                                  provider!
                                      .updateRowsPageNeftCusDet(data: value!);
                                },
                                showFirstLastButtons: true,
                                showCheckboxColumn: false,
                                columns: [
                                  ...
                                  DataColumn2(
                                    label: Center(
                                        child: Text('CustRefId',
                                            style: _tableRowHead)),
                                    size: ColumnSize.S,
                                  ),
                                ],
                                source: DocIdDataSource2(
                                    neftCusDet ?? [], provider, context),
                              ),
                            ),
                          ),
                        ),
