...
class PayCorIdWidget extends StatelessWidget {
  final double? width;
  final double? height;
  final List<PayReImpSendDet>? impsSendDtl;
  final List<PayRptImpsResDt>? impsResDet;
  final List<PayRptneftSftDet>? neftSftDet;
  final List<PayRptSbiTransDet>? SbiTransDet;
  final PayReportController? provider;
  const PayCorIdWidget(
      {super.key,
      this.width,
      this.height,
      this.impsSendDtl,
...
class DocIdDataSource1 extends DataTableSource {
  final List<PayReImpSendDet> data;
  final PayReportController? provider;
...
class DocIdDataSource2 extends DataTableSource {
  final List<PayRptImpsResDt> data;
  final PayReportController? provider;
  final BuildContext context;
...
class DocIdDataSource3 extends DataTableSource {
  final List<PayRptneftSftDet> data;
  final PayReportController? provider;
  final BuildContext context;
...
class DocIdDataSource4 extends DataTableSource {
  final List<PayRptSbiTransDet> data;
  final PayReportController? provider;
  final BuildContext context;
