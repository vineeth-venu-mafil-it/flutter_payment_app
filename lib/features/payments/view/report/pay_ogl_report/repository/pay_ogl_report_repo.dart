...
class PaymentOGLReportRepo {
  ...
  Future<dynamic> payOglReportAccess() async {
    ...
    String p_flag = "OGL_NEFT_IMPS_RE_ACCESS";
    String p_paraval = "1";
  ...
  Future<dynamic> fetchBranch() async {
    ...
    final p_pageval = appDecryptHelper.decryptData(
        ...
        baseKey: EncryptionValue.keyAsString,
        ivKey: EncryptionValue.ivAsString);
    String p_flag = "OGL_NEFT_IMPS_RE_BRANCH_DROP";
    String p_paraval = "1";
  ...
  Future<dynamic> fetchModule() async {
    final encryptToken = await appCacheHelper.getData("token");
    final p_pageval = "1";
    String p_flag = "OGL_NEFT_IMPS_RE_MODULE_DROP";
    String p_paraval = "1";
  ...
  Future<dynamic> fetchBank({required String payType}) async {
    ...
    String p_flag = "OGL_NEFT_IMPS_RE_BANK_DROP";
    String p_paraval = "1";
  ...
  Future<dynamic> fetchOglReport(
    ...
    String p_flag = "OGL_NEFT_IMPS_RE_GENERATE";
    String p_paraval = "1";
  ...
  Future<dynamic> fetchDocId({required String docId}) async {
    ...
    String p_flag = "OGL_NEFT_IMPS_RE_GET_DOCID";
    String p_paraval = "1";
  ...
  Future<dynamic> fetchCusId({required String cusId}) async {
    ...
    String p_flag = "OGL_NEFT_IMPS_RE_GET_CUSID";
    String p_paraval = "1";
  ...
  Future<dynamic> fetchCorId({required String corId}) async {
    ...
    String p_flag = "OGL_NEFT_IMPS_RE_GET_COPID";
    String p_paraval = "1";
