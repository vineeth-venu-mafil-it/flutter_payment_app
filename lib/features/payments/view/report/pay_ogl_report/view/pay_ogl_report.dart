...
import 'package:flutter_payment_app/features/payments/view/report/pay_ogl_report/controller/pay_ogl_report_controller.dart';
import 'package:flutter_payment_app/features/payments/view/report/pay_ogl_report/view/widgets/corid_widget.dart';
...
import '../../pay_ogl_report/view/widgets/docid_widget.dart';

class PayOglReport extends StatelessWidget {
  const PayOglReport({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) =>
          PaymentOGLReportController()..payOglReportAccess(context: context),
      child: Consumer<PaymentOGLReportController>(
                                                                      ...
                                                                      CustomButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            if (provider
                                                                              ...
                                                                              ScaffoldMessenger.of(context).showSnackBar(snackBar);
                                                                            } else if (provider.selectedBranchId ==
                                                                                -1) {
                                                                              final snackBar =
                                                                                  SnackBar(
                                                                              ...
                                                                              provider.fetchOglReport(
                                                                                  context: context,
                                                                                  modId: provider.selectedModule,
                                                                                  payType: provider.selectedPayType,
                                                                                  payBank: provider.selectedBank,
                                                                          ...
                                                                          Row(
                                                                            children: [
                                                                              CustomButton(
                                                                                ...
                                                                                height: 25,
                                                                                onPressed: () {
                                                                                  provider.savePdfOglReport(provider.oglReport, context);
                                                                                },
                                                                              ),
                                                                              ...
                                                                              CustomButton(
                                                                                ...
                                                                                height: 25,
                                                                                onPressed: () {
                                                                                  provider.exportToExcel(provider.oglReport, context);
                                                                                },
                                                                              ),
                                                                            ],
                                                                          ),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      columns: [
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('PaymentMode', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('PaymentBank', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('Module', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('Branch', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('BranchId', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('DocId', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                        ...
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('CustomerName', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                        ...
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('TraDate', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                        ...
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('PaymentDate', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                        ...
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('BankRRN', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('IFSCCode', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('BeneficiaryAccount', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                        ...
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('SequenceNo', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        ),
                                                                        DataColumn2(
                                                                          label: Center(
                                                                              child:
                                                                                  Text('BatchNo', style: _tableRowHead)),
                                                                          size: ColumnSize
                                                                              .S,
                                                                        )
                                                                      ],
                                                                      source: OGLReportDataSource(
                                                                          provider
                                                                              .oglReport,
                                                                          provider,
                                                                          context),
...
class OGLReportDataSource extends DataTableSource {
  final List<OGLReportModel> data;
  final PaymentOGLReportController provider;
  final BuildContext context;

  OGLReportDataSource(this.data, this.provider, this.context);
...
void _showDocId(
    BuildContext context, PaymentOGLReportController provider, double width) {
  showDialog(
